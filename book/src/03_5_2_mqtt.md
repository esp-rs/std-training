...
## Part 1: Publishing the board temperature. 
...
To log the sensor values sent by the board, a helper client is provided under `intro/mqtt/example_client`. It subscribes to the board temperature topic.
