...
`i2c-sensor-reading/solution/src/main.rs` contains a working solution of Part 1.
...
Continue with your code from Part 1. Alternatively you can start with the provided partial solution of Part 1: `i2c-sensor-reading/solution/src/main.rs`.

`i2c-sensor-reading/solution/src/main_2.rs` contains a working solution of Part 2. You can consult it if you need help. 
