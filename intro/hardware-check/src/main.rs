...
fn main() -> anyhow::Result<()> {
    ...
    match *wifi {
        Ok(_) => led.set_pixel(RGB::new(18, 50, 0))?,
        Err(err) => {
            led.set_pixel(RGB::new(50, 18, 0))?;
    ...
    loop {
        ...
        match odd {
            true => led.set_pixel(RGB::new(18, 50, 0))?,
            false => led.set_pixel(RGB::new(18, 0, 50))?,
        }
        odd = !odd;
    }
}
